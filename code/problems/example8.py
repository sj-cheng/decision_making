...
# 		r1 = 0.0 
# 		r2 = 0.0
# 		if self.is_captured(s) or s[8,0] > self.tf:
# 			r1 = s[8,0] / self.tf 
# 			r2 = 1.0 - r1 
# 		reward = np.array([[r1],[r1],[r2],[r2]],dtype=float)
# 		for robot in range (self.num_robots):
# 			if not contains(s[self.state_idxs[robot],:],self.state_lims[self.state_idxs[robot],:]):
# 				reward[robot,0]= -1.0
# 		# if not contains(s[self.state_idxs[0],:],self.state_lims[self.state_idxs[0],:]):
# 		# 	r1 = -1 
# 		# if not contains(s[self.state_idxs[1],:],self.state_lims[self.state_idxs[1],:]):
# 		# 	r1 = -1 
# 		# if not contains(s[self.state_idxs[2],:],self.state_lims[self.state_idxs[2],:]):
# 		# 	r2 = -1 
# 		# if not contains(s[self.state_idxs[3],:],self.state_lims[self.state_idxs[3],:]):
# 		# 	r2 = -1 
